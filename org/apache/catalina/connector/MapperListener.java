...
public class MapperListener extends LifecycleMBeanBase
    ...
    public void startInternal() throws LifecycleException {
        ...
        // 根据connector-service-engine获取默认主机
        // 然后engine-getChildren-getname equal defaultHost
        // 如果查到 则mapper设置defaultHostName
        findDefaultHost();

        Engine engine = (Engine) connector.getService().getContainer();
        // 递归调用，将MapperListener设置为所有容器的ContainerListener和LifeCycleListener
        addListeners(engine);
