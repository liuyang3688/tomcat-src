...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        // 调用Catalina-setServer方法 设置Server节点对应的对象
        ...
        // 调用当前节点的上一级节点的方法 即Server-setGlobalNamingResources
        ...
        // 执行ConnectorCreateRule-begin方法 创建Connector对象
        digester.addRule("Server/Service/Connector",
                         new ConnectorCreateRule());
        // SetAllPropertiesRule-begin方法 设置Connector属性
        digester.addRule("Server/Service/Connector",
                         new SetAllPropertiesRule(new String[]{"executor"}));
        // 将connector设置到Service中
        ...
        // 通过NamingRuleSet将规则打包，每条规则包括(创建对象，设置属性，设置从属)
        ...
        if (log.isDebugEnabled()) {
            log.debug("Digester for server.xml created in " + ( t2-t1 ) + " ms");
        }
        return (digester);
