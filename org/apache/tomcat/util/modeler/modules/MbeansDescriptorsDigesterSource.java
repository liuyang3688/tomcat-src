...
public class MbeansDescriptorsDigesterSource extends ModelerSource
{
    ...
    protected static Digester createDigester() {
        ...
        // mbeans-descriptors/mbean 创建 配置属性 调用add
        ...
        digester.addSetNext
            ("mbeans-descriptors/mbean",
                "add",
            "java.lang.Object");
        // mbeans-descriptors/mbean/attribute 创建 配置属性 addAttribute
        digester.addObjectCreate
        ...
        digester.addSetNext
                ...
                "addAttribute",
            "org.apache.tomcat.util.modeler.AttributeInfo");
        // mbeans-descriptors/mbean/notification 创建 配置属性 调用addNotification
        digester.addObjectCreate
        ...
        digester.addSetNext
            ("mbeans-descriptors/mbean/notification",
                "addNotification",
            "org.apache.tomcat.util.modeler.NotificationInfo");
        // mbeans-descriptors/mbean/notification/descriptor/field 创建 配置属性 调用addField
        digester.addObjectCreate
        ...
        digester.addCallMethod
            ("mbeans-descriptors/mbean/notification/notification-type",
                "addNotifType", 0);
        // mbeans-descriptors/mbean/operation 创建 配置属性 调用addOperation
        digester.addObjectCreate
        ...
        digester.addSetNext
            ("mbeans-descriptors/mbean/operation/descriptor/field",
                "addField",
            "org.apache.tomcat.util.modeler.FieldInfo");
        // mbeans-descriptors/mbean/operation/parameter 创建 配置属性 addParameter
        digester.addObjectCreate
